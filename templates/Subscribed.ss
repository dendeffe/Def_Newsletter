...
<html lang="en">
  <head>
		...
		<title>Je bent ingeschreven - $SiteConfig.Title: $SiteConfig.Tagline</title>
...
<body class="$MainClass">
	...
	<div id="mainContent">
		<div id="mainText">
		<h3>Je bent ingeschreven op onze nieuwsbrief!</h3>
		<p>Je krijgt zometeen een email. Klik op de link in die mail om je inschrijving te bevestigen.</p>
		</div>
	</div><!-- mainContent -->
	</div>
</body>
